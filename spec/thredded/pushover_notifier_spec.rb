...
.", user: author, messageboard: messageboard) }
  ...
  describe "#new_post" do
    let(:helper) { instance_double(Thredded::PushoverNotifier::ContentHelper,post_url: "a link",
      message_for_new_topic_post: "some message", title_for_new_topic_post: "some title")}
